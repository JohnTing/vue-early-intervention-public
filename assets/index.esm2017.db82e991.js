import{a as d,b as js,_ as Qs,C as $s,r as Bt,s as A,j as mt,c as B,e as Xs,S as Js,f as le,m as Pe,g as Zs,L as ei,h as Te,i as yt,k as Se,D as Ct,l as ti,n as ni,o as bn,p as si,q as ii,t as Kt,u as An,v as ri,w as oi,x as He,y as li,z as ci,A as ai}from"./index.d4ccff08.js";const Yt="@firebase/database",zt="0.13.6";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pn=function(n){try{if(typeof window!="undefined"&&typeof window[n]!="undefined"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new ui(e)}}catch{}return new di},j=Pn("localStorage"),nt=Pn("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ri{constructor(e,t,s,i,r=!1,o="",l=!1){this.secure=t,this.namespace=s,this.webSocketOnly=i,this.nodeAdmin=r,this.persistenceKey=o,this.includeNamespaceInQueryParams=l,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=j.get("host:"+e)||this._host}isCacheableHost(){return this.internalHost.substr(0,2)==="s-"}isCustomHost(){return this._domain!=="firebaseio.com"&&this._domain!=="firebaseio-demo.com"}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&j.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}}function Ni(n){return n.host!==n.internalHost||n.isCustomHost()||n.includeNamespaceInQueryParams}function Kn(n,e,t){d(typeof e=="string","typeof type must == string"),d(typeof t=="object","typeof params must == object");let s;if(e===Vn)s=(n.secure?"wss://":"ws://")+n.internalHost+"/.ws?";else if(e===Bn)s=(n.secure?"https://":"http://")+n.internalHost+"/.lp?";else throw new Error("Unknown connection type: "+e);Ni(n)&&(t.ns=n.namespace);const i=[];return L(t,(r,o)=>{i.push(r+"="+o)}),s+i.join("&")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qe={},$e={};function Tt(n){const e=n.toString();return Qe[e]||(Qe[e]=new bi),Qe[e]}function Ai(n,e){const t=n.toString();return $e[t]||($e[t]=e()),$e[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ae;class is extends Ge{static get __EMPTY_NODE(){return Ae}static set __EMPTY_NODE(e){Ae=e}compare(e,t){return he(e.name,t.name)}isDefinedOn(e){throw Te("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return y.MIN}maxPost(){return new y(J,Ae)}makePost(e,t){return d(typeof e=="string","KeyIndex indexValue must always be a string."),new y(e,Ae)}toString(){return".key"}}const oe=new is;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vt{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return m(this._path)?null:Zn(this._path)}get ref(){return new ne(this._repo,this._path)}get _queryIdentifier(){const e=dn(this._queryParams),t=vt(e);return t==="{}"?"default":t}get _queryObject(){return dn(this._queryParams)}isEqual(e){if(e=Se(e),!(e instanceof Vt))return!1;const t=this._repo===e._repo,s=ns(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+Ji(this._path)}}class ne extends Vt{constructor(e,t){super(e,t,new Rt,!1)}get parent(){const e=ts(this._path);return e===null?null:new ne(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}function jo(n,e){return n=Se(n),n._checkNotDeleted("ref"),e!==void 0?pt(n._root,e):n._root}function pt(n,e){return n=Se(n),g(n._path)===null?vo("child","path",e,!1):Fs("child","path",e,!1),new ne(n._repo,I(n._path,e))}function Qo(n,e){n=Se(n),Ws("push",n._path),Ls("push",e,n._path,!0);const t=Hs(n._repo),s=Cr(t),i=pt(n,s),r=pt(n,s);let o;return e!=null?o=Uo(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function Uo(n,e){n=Se(n),Ws("set",n._path),Ls("set",e,n._path,!1);const t=new Ct;return ko(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}io(ne);ro(ne);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yo(n){hi(ci),Qs(new $s("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return qo(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Bt(Yt,zt,n),Bt(Yt,zt,"esm2017")}q.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};q.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Yo();export{$o as g,Qo as p,jo as r};
